...
public class Graph {
    ...
    public void contractEdge(Edge edge_to_contract) {
        ...
        for(int i = 0; i < this.getNbEdges(); i++){
        	if((this.getEdge(i).node_1 == u && this.getEdge(i).node_2 == v) || (this.getEdge(i).node_1 == v && this.getEdge(i).node_2 == u)){
        		this.edges.remove(i);
        		i--;
        	}
        }
        this.removeNode(u);
        for(int i = 0; i < this.getNbEdges(); i++){
        	if(this.getEdge(i).node_1 == u)
        		this.getEdge(i).node_1 = v;
        	if(this.getEdge(i).node_2 == u)
        		this.getEdge(i).node_2 = v;
        }
    }
